...
Version  : 1.0.5
Release  : 3
URL      : https://files.pythonhosted.org/packages/e2/d3/d1bd06dfca649a3ae2e8fc35a8042b25e17da77e15cbcb87a0d39f1f69df/pytest-flake8-1.0.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/e2/d3/d1bd06dfca649a3ae2e8fc35a8042b25e17da77e15cbcb87a0d39f1f69df/pytest-flake8-1.0.5.tar.gz
...
%prep
%setup -q -n pytest-flake8-1.0.5
cd %{_builddir}/pytest-flake8-1.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587748036
...
cp %{_builddir}/pytest-flake8-1.0.5/LICENSE %{buildroot}/usr/share/package-licenses/pytest-flake8/ce2741b8c1b2d258bba51a44617e1dbce6a3829b
